...
<head>
	<meta charset="utf-8">
	<title>Localizador IP - W4Y</title>
...
echo '<tr><td class="column1">'.$ip.'</td>';
echo '<td class="column1">'.$data.'</td>';
echo '<td class="column1">'.$pais.'</td>';
echo '<td class="column1">'.$continente.'</td>';
echo '<td class="column1">'.$latitude.'</td>';
echo '<td class="column1">'.$longitude.'</td>';
echo '<td class="column1">'.$cidade.'</td>';
echo '<td class="column1">'.$useragente.'</td></tr>';
